...
#link("https://uppaal.org/")[Uppaal] of search-and-rescue scenarios. Inside a
...
The model adopted for the search-and-rescue mission involves 3 different types
...
- *First-responders*:
  - *Assisting*: When a civilian _in-need_ is within a 1-cell range, the _first-responder_ will
...
- *Drones*: They survey their surroundings, limited by the field of view $N_v$ of
  ...
  When two civilians, one _in_need_ and one free, are detected the drone can instruct
  the free civilian to assist the _in_need_ directly or to contact a _first-responder_
